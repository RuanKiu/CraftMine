public class Matrix4x4
{
  ...
  public static void quickInverse(Matrix4x4 matrix)
  {
    Matrix4x4 m = new Matrix4x4();
    m.setValue(0, 0, matrix.getValue(0, 0)); m.setValue(0, 1, matrix.getValue(1, 0)); m.setValue(0, 2, matrix.getValue(2, 0));
    m.setValue(1, 0, matrix.getValue(0, 1)); m.setValue(1, 1, matrix.getValue(1, 1)); m.setValue(1, 2, matrix.getValue(2, 1));
  ...
  public static void createLookAtViewTransform(Matrix4x4 matrix, Vector3D v, Vector3D t, Vector3D u)
  {
  ...
  public static void createFPSViewTransform(Matrix4x4 matrix, Vector3D pos, double pitch, double yaw)
  {
